...
export namespace client {
    ...
    interface IGetControl {
        ...
        nightLightTimeout?: (boolean|null);

        /** GetControl sensorDataTransferEn */
        sensorDataTransferEn?: (boolean|null);
    }

    /** Represents a GetControl. */
    class GetControl implements IGetControl {

        /**
         * Constructs a new GetControl.
         * @param [properties] Properties to set
         */
        constructor(properties?: client.IGetControl);

        /** GetControl ptz. */
        public ptz: boolean;

        /** GetControl nightLight. */
        public nightLight: boolean;

        /** GetControl nightLightTimeout. */
        public nightLightTimeout: boolean;

        /** GetControl sensorDataTransferEn. */
        public sensorDataTransferEn: boolean;

        /**
         * Creates a new GetControl instance using the specified properties.
         * @param [properties] Properties to set
         * @returns GetControl instance
         */
        public static create(properties?: client.IGetControl): client.GetControl;

        /**
         * Encodes the specified GetControl message. Does not implicitly {@link client.GetControl.verify|verify} messages.
         * @param message GetControl message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: client.IGetControl, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: client.IGetControl, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): client.GetControl;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): client.GetControl;
         ...
         * @returns GetControl
         */
        public static fromObject(object: { [k: string]: any }): client.GetControl;

        /**
         * Creates a plain object from a GetControl message. Also converts values to other types if specified.
         * @param message GetControl
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: client.GetControl, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    interface IRequest {
        ...
        /** Request getControl */
        getControl?: (client.IGetControl|null);
    ...
    class Request implements IRequest {
        ...
        /** Request getControl. */
        public getControl?: (client.IGetControl|null);
