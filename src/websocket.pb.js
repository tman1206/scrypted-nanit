...
$root.client = (function() {
    ...
    client.GetControl = (function() {

        /**
         * Properties of a GetControl.
         * @memberof client
         * @interface IGetControl
         * @property {boolean|null} [ptz] GetControl ptz
         * @property {boolean|null} [nightLight] GetControl nightLight
         * @property {boolean|null} [nightLightTimeout] GetControl nightLightTimeout
         * @property {boolean|null} [sensorDataTransferEn] GetControl sensorDataTransferEn
         */

        /**
         * Constructs a new GetControl.
         * @memberof client
         * @classdesc Represents a GetControl.
         * @implements IGetControl
         * @constructor
         * @param {client.IGetControl=} [properties] Properties to set
         */
        function GetControl(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * GetControl ptz.
         * @member {boolean} ptz
         * @memberof client.GetControl
         * @instance
         */
        GetControl.prototype.ptz = false;

        /**
         * GetControl nightLight.
         * @member {boolean} nightLight
         * @memberof client.GetControl
         * @instance
         */
        GetControl.prototype.nightLight = false;

        /**
         * GetControl nightLightTimeout.
         * @member {boolean} nightLightTimeout
         * @memberof client.GetControl
         * @instance
         */
        GetControl.prototype.nightLightTimeout = false;

        /**
         * GetControl sensorDataTransferEn.
         * @member {boolean} sensorDataTransferEn
         * @memberof client.GetControl
         * @instance
         */
        GetControl.prototype.sensorDataTransferEn = false;

        /**
         * Creates a new GetControl instance using the specified properties.
         * @function create
         * @memberof client.GetControl
         * @static
         * @param {client.IGetControl=} [properties] Properties to set
         * @returns {client.GetControl} GetControl instance
         */
        GetControl.create = function create(properties) {
            return new GetControl(properties);
        };

        /**
         * Encodes the specified GetControl message. Does not implicitly {@link client.GetControl.verify|verify} messages.
         * @function encode
         * @memberof client.GetControl
         * @static
         * @param {client.IGetControl} message GetControl message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        GetControl.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ptz != null && Object.hasOwnProperty.call(message, "ptz"))
                writer.uint32(/* id 1, wireType 0 =*/8).bool(message.ptz);
            if (message.nightLight != null && Object.hasOwnProperty.call(message, "nightLight"))
                writer.uint32(/* id 2, wireType 0 =*/16).bool(message.nightLight);
            if (message.nightLightTimeout != null && Object.hasOwnProperty.call(message, "nightLightTimeout"))
                writer.uint32(/* id 3, wireType 0 =*/24).bool(message.nightLightTimeout);
            if (message.sensorDataTransferEn != null && Object.hasOwnProperty.call(message, "sensorDataTransferEn"))
                writer.uint32(/* id 4, wireType 0 =*/32).bool(message.sensorDataTransferEn);
            return writer;
        };

        /**
         * Encodes the specified GetControl message, length delimited. Does not implicitly {@link client.GetControl.verify|verify} messages.
         * @function encodeDelimited
         * @memberof client.GetControl
         * @static
         * @param {client.IGetControl} message GetControl message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GetControl.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a GetControl message from the specified reader or buffer.
         * @function decode
         * @memberof client.GetControl
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {client.GetControl} GetControl
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GetControl.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.GetControl();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.ptz = reader.bool();
                        break;
                    }
                case 2: {
                        message.nightLight = reader.bool();
                        break;
                    }
                case 3: {
                        message.nightLightTimeout = reader.bool();
                        break;
                    }
                case 4: {
                        message.sensorDataTransferEn = reader.bool();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Decodes a GetControl message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof client.GetControl
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GetControl.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GetControl.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ptz != null && message.hasOwnProperty("ptz"))
                if (typeof message.ptz !== "boolean")
                    return "ptz: boolean expected";
            if (message.nightLight != null && message.hasOwnProperty("nightLight"))
                if (typeof message.nightLight !== "boolean")
                    return "nightLight: boolean expected";
            if (message.nightLightTimeout != null && message.hasOwnProperty("nightLightTimeout"))
                if (typeof message.nightLightTimeout !== "boolean")
                    return "nightLightTimeout: boolean expected";
            if (message.sensorDataTransferEn != null && message.hasOwnProperty("sensorDataTransferEn"))
                if (typeof message.sensorDataTransferEn !== "boolean")
                    return "sensorDataTransferEn: boolean expected";
            return null;
        };

        /**
         * Creates a GetControl message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof client.GetControl
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {client.GetControl} GetControl
         */
        GetControl.fromObject = function fromObject(object) {
            if (object instanceof $root.client.GetControl)
                return object;
            var message = new $root.client.GetControl();
            if (object.ptz != null)
                message.ptz = Boolean(object.ptz);
            if (object.nightLight != null)
                message.nightLight = Boolean(object.nightLight);
            if (object.nightLightTimeout != null)
                message.nightLightTimeout = Boolean(object.nightLightTimeout);
            if (object.sensorDataTransferEn != null)
                message.sensorDataTransferEn = Boolean(object.sensorDataTransferEn);
            return message;
        };

        /**
         * Creates a plain object from a GetControl message. Also converts values to other types if specified.
         * @function toObject
         * @memberof client.GetControl
         * @static
         * @param {client.GetControl} message GetControl
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        GetControl.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.ptz = false;
                object.nightLight = false;
                object.nightLightTimeout = false;
                object.sensorDataTransferEn = false;
            }
            if (message.ptz != null && message.hasOwnProperty("ptz"))
                object.ptz = message.ptz;
            if (message.nightLight != null && message.hasOwnProperty("nightLight"))
                object.nightLight = message.nightLight;
            if (message.nightLightTimeout != null && message.hasOwnProperty("nightLightTimeout"))
                object.nightLightTimeout = message.nightLightTimeout;
            if (message.sensorDataTransferEn != null && message.hasOwnProperty("sensorDataTransferEn"))
                object.sensorDataTransferEn = message.sensorDataTransferEn;
            return object;
        };

        /**
         * Converts this GetControl to JSON.
         * @function toJSON
         * @memberof client.GetControl
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        GetControl.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for GetControl
         * @function getTypeUrl
         * @memberof client.GetControl
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        GetControl.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/client.GetControl";
        };
    ...
    client.Request = (function() {
         ...
         * @property {client.IGetControl|null} [getControl] Request getControl
        ...
        /**
         * Request getControl.
         * @member {client.IGetControl|null|undefined} getControl
         * @memberof client.Request
         * @instance
         */
        Request.prototype.getControl = null;
        ...
        Request.encode = function encode(message, writer) {
            ...
            if (message.getControl != null && Object.hasOwnProperty.call(message, "getControl"))
                $root.client.GetControl.encode(message.getControl, writer.uint32(/* id 17, wireType 2 =*/138).fork()).ldelim();
        ...
        Request.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 17: {
                        message.getControl = $root.client.GetControl.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
        ...
        Request.verify = function verify(message) {
            ...
            if (message.getControl != null && message.hasOwnProperty("getControl")) {
                var error = $root.client.GetControl.verify(message.getControl);
                if (error)
                    return "getControl." + error;
            }
        ...
        Request.fromObject = function fromObject(object) {
            ...
            if (object.getControl != null) {
                if (typeof object.getControl !== "object")
                    throw TypeError(".client.Request.getControl: object expected");
                message.getControl = $root.client.GetControl.fromObject(object.getControl);
            }
        ...
        Request.toObject = function toObject(message, options) {
            ...
            if (message.getControl != null && message.hasOwnProperty("getControl"))
                object.getControl = $root.client.GetControl.toObject(message.getControl, options);
            if (message.getLogs != null && message.hasOwnProperty("getLogs"))
    ...
    client.Response = (function() {
         ...
         * @property {client.IControl|null} [control] Response control
         */
         ...
         * @instance
         */
        Response.prototype.control = null;
        ...
        Response.encode = function encode(message, writer) {
            ...
            if (message.control != null && Object.hasOwnProperty.call(message, "control"))
                $root.client.Control.encode(message.control, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
            return writer;
        };
        ...
        Response.fromObject = function fromObject(object) {
            ...
            if (object.control != null) {
                if (typeof object.control !== "object")
                    throw TypeError(".client.Response.control: object expected");
                message.control = $root.client.Control.fromObject(object.control);
            }
            return message;
        };
